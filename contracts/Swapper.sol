...
contract Swapper {
    ...
    constructor( IERC20 tokenA_, IERC20 tokenB_, IERC20 tokenC_) {
        // tokenA = new Token("BEAR", "BEAR", 1_000_000 * 1E18, msg.sender);
           tokenA = tokenA_;
           tokenB = tokenB_;
           tokenC = tokenC_;
           
        // tokenB = new Token("ICE", "ICE", 1_000_000 * 1E18, msg.sender);

        // tokenC = new Token("PANDA", "PD", 1_000_000 * 1E18, address(this));
    }
